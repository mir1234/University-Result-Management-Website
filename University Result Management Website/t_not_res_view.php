<?php include("include/t_header.php");
	...
	<table style="margin-left:260px;">
		...
		<a href="t_view_notice.php?t_id=<?php echo $arr['t_id'];?>& semester=<?php echo $arr['semester'];?>& year=<?php echo $arr['year'];?>& dept_id=<?php echo $arr['dept_id'];?>& course_code=<?php echo $arr['course_id'];?>" style="float:left;margin-left:50px;"> << Back</a>
