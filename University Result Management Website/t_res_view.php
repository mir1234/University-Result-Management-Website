<?php include("include/t_header.php");
	...
	<table style="margin-left:260px;">
		...
		<a href="t_result.php?& course_code=<?php echo $_REQUEST['course_code']; ?>&year=<?php echo $_REQUEST['year']; ?>&semester=<?php echo $_REQUEST['semester']; ?>" style="float:left;margin-left:50px;"> << Back</a>
