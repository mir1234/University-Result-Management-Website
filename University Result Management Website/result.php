...
<?php
 ...
 if(isset($_REQUEST['paging']))
        ...
        $sql = "SELECT * from result where dept_id='$_REQUEST[id]' AND status='active' ";
        //echo $sql;
      ...
      if(isset($_REQUEST['name'])){
        $sql="select * from result where dept_id LIKE '%$_REQUEST[id]%' AND status LIKE 'active' order by id desc limit $startfrom, $listing_per_page";
		//echo $sql;
...
?>
 ...
 <h1 style="margin-top:200px;"> Recent Results </h1>
 ...
 <table width="950px" style="border: 2px solid gray;font-size:13px;" align="center" >
		...
		{   $fl=1;?>
			<tr style="text-align:center;height:25px;">
				...
				<td><a href="res_view.php?id=<?php echo $row['id'];?>&ids=<?php echo $_GET['id'];?>">view</a> </td>
			</tr>
		...
		<form action="result.php?id=<?php echo $_REQUEST['id']; ?>" name="form1" method="post" style="margin-left:675px;">
