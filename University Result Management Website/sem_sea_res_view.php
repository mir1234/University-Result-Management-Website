<?php include("include/header.php");
	...
	<table style="margin-left:260px;">
		<tr height="150">
			<td valign="top"></td>
			<td><?php 
						$sql="select * from result where id='$_REQUEST[id]' ";
					  $res=mysql_query($sql);
		...
		<a href="sem_search_res.php?s_id=<?php echo $_REQUEST['ids']?>& year=<?php echo $arr['year']?>& semester=<?php echo $arr['semester']?>" style="float:left;margin-left:50px;"> << Back</a>
