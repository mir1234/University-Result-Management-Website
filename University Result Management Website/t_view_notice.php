...
<?php
 ...
 if(isset($_REQUEST['paging']))
        ...
        $sql = "SELECT * from result where course_id='$_REQUEST[course_code]' AND dept_id='$_REQUEST[dept_id]' AND t_id='$_REQUEST[t_id]' AND semester='$_REQUEST[semester]' AND year='$_REQUEST[year]' ";
        //echo $sql;
      ...
      if(isset($_REQUEST['name'])){
               $sql="select * from result where course_id='$_REQUEST[course_code]' AND dept_id='$_REQUEST[dept_id]' AND t_id='$_REQUEST[t_id]' AND semester='$_REQUEST[semester]' AND year='$_REQUEST[year]' order by id desc limit $startfrom, $listing_per_page";
 ...
 <table width="800px" style="border: 2px solid gray;" align="center" >
		...
		{   ?>
			<tr style="text-align:center;">
				...
				<td><a href="t_not_res_view.php?id=<?php echo $row['id'];?>&ids=<?php echo $s_id;?>">view</a> </td>
			</tr>
		...
		<form action="t_view_notice.php?t_id=<?php echo $_REQUEST['t_id'];?>& semester=<?php echo $_REQUEST['semester'];?>& year=<?php echo $_REQUEST['year'];?>& dept_id=<?php echo $_REQUEST['dept_id'];?>& course_code=<?php echo $_REQUEST['course_code'];?>" name="form1" method="post" style="margin-left:675px;">
